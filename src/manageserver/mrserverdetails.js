          ...
          <tbody>
            {filteredData.map((item, index) => (
              <tr key={index}>
                        ...
                        >
                          ...
                          {role.Status !== "NA" && (
                            <>
                              {role.Status === "Stopped" && (
                                <button
                                  onClick={() => handleStart(role.Name, item.ComputerName)}
                                  style={{ marginRight: "5px",background:'#0cb061' }}
                                >
                                  Start
                                </button>
                              )}
                               <button
                                onClick={() => handleStop(role.Name, item.ComputerName)}
                                style={{ marginRight: "5px" ,background:"#b95d5d"}}
                              >
                                Stop
                              </button>
                              <button
                                onClick={() => handleRestart(role.Name, item.ComputerName)}
                                style={{ marginRight: "5px",background: "#635279" }}
                              >
                                Restart
                              </button>
                            </>
                ...
                <td>
                  <button onClick={() => handleStopAll(item.ComputerName)}
                  style={{ marginBottom: "5px" ,background:"#b95d5d"}}
                  >
                    Stop All
                  </button>
                  <button onClick={() => handleStartAll(item.ComputerName)}
                  style={{ marginBottom: "5px",background:'#0cb061' }}
                  >
                    Start All
                  </button>
                  <button onClick={() => handleRestartAll(item.ComputerName)} 
